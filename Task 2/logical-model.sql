...
ALTER TABLE instructor_email ADD CONSTRAINT FK_instructor_email_0 FOREIGN KEY (email_id) REFERENCES email (email_id);
ALTER TABLE instructor_email ADD CONSTRAINT FK_instructor_email_1 FOREIGN KEY (instructor_id) REFERENCES instructor (instructor_id);
